	...
	return &cli.App{
		...
		Commands: []*cli.Command{
			// service
			{
				...
				Action:       noArgsMiddleware(commands.Init),
			...
			},
			{
				...
				Action:       noArgsMiddleware(commands.Status),
				OnUsageError: handleUsageError,
				Category:     serviceCategory,
			},
			// metadata management
			...
			// filesystem operations
			{
				...
				Action:       noArgsMiddleware(commands.Collect),
				OnUsageError: handleUsageError,
			...
			},
			{
				...
				Action:      noArgsMiddleware(commands.Extract),
				Flags: []cli.Flag{
					&cli.BoolFlag{
						Name:  "no-diff",
						Value: false,
